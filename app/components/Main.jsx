...
//       console.log("Новини з API:", data); // Дивимося, що приходить
//       setNews(Array.isArray(data) ? data : []); // Запобігаємо помилці
//     };
...
//     return date.toLocaleDateString("uk-UA"); // Формат дати для України
//   };
